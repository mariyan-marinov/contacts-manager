...
// ISO 3166-1 alpha-2, the same set the API validates against. Names come from the browser rather
// than from a table shipped here, so only the codes need keeping in step.
const alpha2Codes =
